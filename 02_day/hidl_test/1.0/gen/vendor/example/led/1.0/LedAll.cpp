#define LOG_TAG "vendor.example.led@1.0::Led"
...
#include <vendor/example/led/1.0/BpHwLed.h>
#include <vendor/example/led/1.0/BnHwLed.h>
#include <vendor/example/led/1.0/BsLed.h>
...
const char* ILed::descriptor("vendor.example.led@1.0::ILed");
...
// no default implementation for: ::android::hardware::Return<void> ILed::LEDON()

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> ILed::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::vendor::example::led::V1_0::ILed::descriptor,
...
::android::hardware::Return<void> ILed::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::example::led::V1_0::ILed::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::example::led::V1_0::ILed>> ILed::castFrom(const ::android::sp<::vendor::example::led::V1_0::ILed>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::example::led::V1_0::ILed>> ILed::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ILed, ::android::hidl::base::V1_0::IBase, BpHwLed>(
            parent, "vendor.example.led@1.0::ILed", emitError);
}

BpHwLed::BpHwLed(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ILed>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.example.led@1.0", "ILed") {
}
...
// Methods from ::vendor::example::led::V1_0::ILed follow.
::android::hardware::Return<void> BpHwLed::_hidl_LEDON(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ILed::LEDON::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.example.led", "1.0", "ILed", "LEDON", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* LEDON */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.example.led", "1.0", "ILed", "LEDON", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::vendor::example::led::V1_0::ILed follow.
::android::hardware::Return<void> BpHwLed::LEDON(){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::example::led::V1_0::BpHwLed::_hidl_LEDON(this, this);
...
BnHwLed::BnHwLed(const ::android::sp<ILed> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.example.led@1.0", "ILed") { 
...
// Methods from ::vendor::example::led::V1_0::ILed follow.
::android::status_t BnHwLed::_hidl_LEDON(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ILed::LEDON::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.example.led", "1.0", "ILed", "LEDON", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ILed*>(_hidl_this->getImpl().get())->LEDON();
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.example.led", "1.0", "ILed", "LEDON", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwLed::onTransact(
    ...
    switch (_hidl_code) {
        case 1 /* LEDON */:
        {
            _hidl_err = ::vendor::example::led::V1_0::BnHwLed::_hidl_LEDON(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsLed::BsLed(const ::android::sp<::vendor::example::led::V1_0::ILed> impl) : ::android::hardware::details::HidlInstrumentor("vendor.example.led@1.0", "ILed"), mImpl(impl) {
...
bool ILed::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.example.led@1.0::ILed",
